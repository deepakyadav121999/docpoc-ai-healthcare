...
const ModernSignUp: React.FC<SignUpProps> = ({ setAuthPage, onLogin }) => {
  return (
    <div className="h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        {/* Floating Circles */}
        <div className="absolute top-20 left-10 w-32 h-32 bg-green-200/30 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute top-40 right-20 w-24 h-24 bg-emerald-300/40 rounded-full blur-xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-20 left-20 w-40 h-40 bg-green-100/50 rounded-full blur-xl animate-pulse delay-500"></div>
        <div className="absolute bottom-40 right-10 w-28 h-28 bg-emerald-200/30 rounded-full blur-xl animate-pulse delay-1500"></div>

        {/* Additional Desktop Background Elements */}
        <div className="hidden lg:block absolute top-1/4 left-1/6 w-20 h-20 bg-green-300/20 rounded-full blur-lg animate-pulse delay-300"></div>
        <div className="hidden lg:block absolute top-1/3 right-1/4 w-16 h-16 bg-emerald-400/25 rounded-full blur-lg animate-pulse delay-700"></div>
        <div className="hidden lg:block absolute bottom-1/3 left-1/5 w-24 h-24 bg-green-200/30 rounded-full blur-lg animate-pulse delay-1200"></div>
        <div className="hidden lg:block absolute bottom-1/4 right-1/6 w-18 h-18 bg-emerald-300/20 rounded-full blur-lg animate-pulse delay-900"></div>

        {/* Medical Icons */}
        <div className="absolute top-48 right-1/3 w-6 h-6 text-emerald-300/40 animate-pulse">
        ...
        <div className="hidden lg:block absolute top-1/4 left-1/4 w-8 h-8 text-green-300/30 animate-bounce">
          <svg fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
          </svg>
        </div>
        <div className="hidden lg:block absolute bottom-1/4 right-1/4 w-6 h-6 text-emerald-300/30 animate-pulse delay-500">
          <svg fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
          </svg>
        </div>
      ...
      <div className="flex h-screen relative z-10">
        ...
        <div className="flex w-full flex-col justify-center px-4 py-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            ...
            {/* Sign Up Form */}
            <ModernSignup setAuthPage={setAuthPage} onLogin={onLogin} />
          ...
          <div className="relative flex h-full flex-col justify-center px-12 py-6">
            <div className="mx-auto max-w-md">
              ...
              <p className="text-base text-blue-100 leading-relaxed mb-4">
                Join the future of healthcare management. DocPoc provides
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center">
                  ...
                  <p className="ml-3 text-blue-100">Easy setup in minutes</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <p className="text-blue-100 text-sm italic">
                      &ldquo;Setting up DocPoc was incredibly easy. Within
                      hours, we were managing appointments and patient records
                      seamlessly.&rdquo;
                    </p>
