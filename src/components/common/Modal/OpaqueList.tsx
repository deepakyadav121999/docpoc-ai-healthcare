...
export default function OpaqueList(props: { modalType: { view: MODAL_TYPES, edit: MODAL_TYPES, delete: MODAL_TYPES }, modalTitle: string, actionButtonName?: string, userId: string, onPatientDelete: () => void; }) {
