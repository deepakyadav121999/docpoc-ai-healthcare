...
export default function CardSegmented(props: {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:gap-6 2xl:gap-7.5 md:grid-cols-1">
      {(props.data.headrSubTitle || props.data.headrTitle || props.data.img) && <div className="flex gap-3">
        <div>
          {props.data.img && (
            <Image
              alt="section logo"
        ...
        <div className="flex flex-col">
          {props.data.headrTitle && <p className="text-md">{props.data.headrTitle}</p>}
          {props.data.headrSubTitle && <p className="text-small text-default-500">
