    ...
    <div>
      ...
      {loginMethod === "password" && (
        <form onSubmit={handleSignInWithPassword}>
          ...
          <div className="mb-4">
            <label htmlFor="userInput" className="mb-2.5 block font-medium text-dark dark:text-white">
              Email or Phone
            </label>
      ...
      {loginMethod === "otp" && (
        <form onSubmit={handleOtpVerification}>
          ...
          {isOtpFieldVisible && (
            <div className="mb-4">
              <label htmlFor="otp" className="mb-2.5 block font-medium text-dark dark:text-white">
                OTP
              </label>
              <input
                type="text"
