...
//       });
//       setPatientList(
//         response3.data.rows.map((patient: any) => ({
//           label: patient.name,
//           value: patient.id,
//           description: `${patient.phone} | ${patient.email}`,
//           dob: patient.dob,
...
const NewAppointment: React.FC<NewAppointmentProps> = ({
  ...
  return (
    <div className="appointment-container">
      <style jsx global>{`
        /* Global styles to prevent iOS zooming and layout issues */
