...
// Support info - same as in SupportForm
const supportInfo = {
...
const DropdownUser = () => {
  ...
  const handleNavigation = async (
    ...
    try {
      ...
      // Using Promise.all to handle both the navigation and artificial delay
      await Promise.all([
        router.push(path),
        ...
        {dropdownOpen && (
          ...
          >
            ...
            <ul className="flex flex-col gap-1 border-y-[0.5px] border-stroke p-2.5 dark:border-dark-3">
              {/* <li>
                <button
                  onClick={() => handleNavigation("/profile", "viewProfile")}
                ...
                >
                  ...
                  {loadingStates.viewProfile && <Spinner size="sm" />}
                </button>
              </li> */}
              ...
              <li>
                <button
                  onClick={() =>
                    handleNavigation("/pages/settings", "settings")
                  }
                  className="flex w-full items-center gap-2.5 rounded-[7px] p-2.5 text-sm font-medium text-dark-4 duration-300 ease-in-out hover:bg-gray-2 hover:text-dark dark:text-dark-6 dark:hover:bg-dark-3 dark:hover:text-white lg:text-base"
                >
                  <svg
                  ...
                  {loadingStates.settings && <Spinner size="sm" />}
                </button>
              </li>
            </ul>
            <div className="p-2.5">
            ...
            {/* Support Section - Only visible on small screens */}
            <div className="lg:hidden">
              <div className="border-t-[0.5px] border-stroke dark:border-dark-3 p-2.5">
                <div className="relative">
                  ...
                  >
                    ...
                    <span>Help</span>
                    <svg
                      className={`w-4 h-4 transition-transform ${supportModalOpen ? "rotate-180" : ""}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  {/* Support Dropdown - Same UI as SupportForm */}
                  {supportModalOpen && (
                    <div
                      className="absolute bottom-full left-0 mb-2 w-72 bg-white dark:bg-gray-dark border border-gray-200 dark:border-gray-600 rounded-lg shadow-xl dark:shadow-2xl z-50"
                      onMouseEnter={handleSupportMouseEnter}
                      onMouseLeave={handleSupportMouseLeave}
                    >
                      <div className="p-4">
