...
const SettingBoxes = () => {
  ...
  const handlePhotoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const sanitizedUsername = profile.name.replace(/\s+/g, "").toLowerCase().slice(0, 9);
    ...
    try {
      ...
      if (response.data) {
        ...
        console.log("Profile picture updated successfully:", updateResponse.data);
        ...
        <div className="p-7">
          <form>
            <div className="mb-4 flex items-center gap-3">
              ...
              {profilePhotoUrl ? (
                  <Image
                    src={profilePhotoUrl ? profilePhotoUrl:"/images/user/user-03.png"}
                    width={55}
                    height={55}
                    alt="User"
