      ...
      <div className="grid grid-cols-5 gap-8">
        <div className="col-span-5 xl:col-span-3">
          <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
            ...
            <div className="p-7">
              {/* Show onboarding message if not loading and no designation (including unsaved selection) */}
              {!loading && !currentDesignation && !tempDesignation && (
                <div className="mb-4 p-3 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 rounded">
                  Please set your designation to continue onboarding.
                </div>
              )}
